...
(function () {
  ...
  const i18n = {
    es: {
      ...
      map_title: 'Nuestro mapa <span class="serif-italic">curado.</span>',
      map_desc: 'Hemos mapeado nuestros lugares favoritos de la ciudad. Filtra por categorías y planifica tu día desde Palogrande.',
      cat_todo: 'Todo',
    ...
    en: {
      ...
      map_title: 'Our curated <span class="serif-italic">map.</span>',
      map_desc: 'We\'ve mapped out our favorite spots in the city. Filter by category and plan your day starting from Palogrande.',
      cat_todo: 'All',
      cat_escapadas: 'Escapadas',
      cat_birding: 'Birding',
